 ...
 * @author Home
 */
public class AgregarRegistroFrameVh extends javax.swing.JFrame {

    /**
     * Creates new form AgregarRegistroFrameVh
     */
private JTextField txtCodigo, txtCapacidad, txtTamanoLote, txtUbicacion, txtPrecio, txtUtilidades;
    ...
    private void guardarRegistro() {
        ...
        String sql = "INSERT INTO VioHuertosSanIsidroLaJoya (CodigoVH, Capacidad, TamanodeLote, Ubicacion, Precio, Utilidades) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarRegistroFrameVh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarRegistroFrameVh().setVisible(true);
            }
        });
    }
