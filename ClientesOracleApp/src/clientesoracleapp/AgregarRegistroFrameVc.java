...
public class AgregarRegistroFrameVc extends javax.swing.JFrame {
...
private JTextField txtCodigo, txtCapacidad, txtTamanoLote, txtUbicacion, txtPrecio, txtUtilidades;
    ...
    private void guardarRegistro() {
        ...
        String sql = "INSERT INTO VillaCattleya (CodigoVC, Capacidad, TamanodeLote, Ubicacion, Precio, Utilidades) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarRegistroFrameVc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgregarRegistroFrameVc().setVisible(true);
            }
        });
    }
