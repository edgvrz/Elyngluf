...
public class Viohuertossanisidrolajoya extends javax.swing.JFrame {

    private JTable tablaVH;
    ...
    private static final String PASSWORD = "Oracle";
        ...
        public Viohuertossanisidrolajoya() {
        ...
        // Título
        JLabel label = new JLabel("Gestión - Vio Huertos San Isidro La Joya", SwingConstants.CENTER);
        ...
        JLabel lblBuscar = new JLabel("Buscar por Código VH o Ubicación:");
        ...
        // Tabla
        String[] columnas = { "Código VH", "Capacidad", "Tamaño de Lote", "Ubicación", "Precio", "Utilidades" };
        ...
        tablaVH = new JTable(modeloTabla);
        tablaVH.setBackground(Color.WHITE);
        tablaVH.setForeground(Color.DARK_GRAY);
        tablaVH.setGridColor(new Color(200, 200, 200));
        tablaVH.setRowHeight(25);
        tablaVH.setFillsViewportHeight(true);

        JTableHeader header = tablaVH.getTableHeader();
        header.setBackground(new Color(100, 149, 237));
        header.setForeground(Color.WHITE);
        header.setFont(new Font("Segoe UI", Font.BOLD, 14));

        JScrollPane scrollPane = new JScrollPane(tablaVH);
        ...
        panelCampos.add(crearEtiqueta("Código VH:", etiquetaFont, colorTexto), gbc);
        gbc.gridx = 1;
        txtCodigo = crearCampoTexto("Código VH");
        ...
        tablaVH.getSelectionModel().addListSelectionListener(event -> {
            if (!event.getValueIsAdjusting() && tablaVH.getSelectedRow() != -1) {
    ...
    private void cargarDatosCamposDesdeTabla() {
        int fila = tablaVH.getSelectedRow();
        if (fila >= 0) {
    ...
    private void limpiarCampos() {
        ...
        tablaVH.clearSelection();
    }

    private void agregarRegistro() {
        AgregarRegistroFrameVh agregarFrame = new AgregarRegistroFrameVh();
    ...
    private void modificarRegistro() {
        ...
        String sql = "UPDATE VioHuertosSanIsidroLaJoya SET Capacidad = ?, TamanodeLote = ?, Ubicacion = ?, Precio = ?, Utilidades = ? WHERE CodigoVH = ?";
    ...
    private void eliminarRegistro() {
        ...
        int confirm = JOptionPane.showConfirmDialog(this, "¿Está seguro de eliminar el registro con Código VH " + codigo + "?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);

        if (confirm == JOptionPane.YES_OPTION) {
            String sql = "DELETE FROM VioHuertosSanIsidroLaJoya WHERE CodigoVH = ?";
    ...
    private void cargarDatosDesdeBD() {
        ...
        String consulta = "SELECT CodigoVH, Capacidad, TamanodeLote, Ubicacion, Precio, Utilidades FROM VioHuertosSanIsidroLaJoya";
    ...
    private void buscarRegistros() {
        ...
        modeloTabla.setRowCount(0);
        String consulta = "SELECT CodigoVH, Capacidad, TamanodeLote, Ubicacion, Precio, Utilidades FROM VioHuertosSanIsidroLaJoya WHERE LOWER(Ubicacion) LIKE ? OR CodigoVH = ?";
    ...
    // Aquí luego pondremos el método guardarRegistro()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Viohuertossanisidrolajoya.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Viohuertossanisidrolajoya().setVisible(true);
            }
        });
    }
