...
public class VillaCattleya extends javax.swing.JFrame {

    
     private JTable tablaVC;
    ...
    private static final String PASSWORD = "Oracle";
        ...
        // Título
        JLabel label = new JLabel("Gestión - Villa Cattleya", SwingConstants.CENTER);
        ...
        JLabel lblBuscar = new JLabel("Buscar por Código VC o Ubicación:");
        ...
        // Tabla
        String[] columnas = { "Código VC", "Capacidad", "Tamaño de Lote", "Ubicación", "Precio", "Utilidades" };
        ...
        tablaVC = new JTable(modeloTabla);
        tablaVC.setBackground(Color.WHITE);
        tablaVC.setForeground(Color.DARK_GRAY);
        tablaVC.setGridColor(new Color(200, 200, 200));
        tablaVC.setRowHeight(25);
        tablaVC.setFillsViewportHeight(true);

        JTableHeader header = tablaVC.getTableHeader();
        header.setBackground(new Color(100, 149, 237));
        header.setForeground(Color.WHITE);
        header.setFont(new Font("Segoe UI", Font.BOLD, 14));

        JScrollPane scrollPane = new JScrollPane(tablaVC);
        ...
        panelCampos.add(crearEtiqueta("Código VC:", etiquetaFont, colorTexto), gbc);
        gbc.gridx = 1;
        txtCodigo = crearCampoTexto("Código VC");
        ...
        tablaVC.getSelectionModel().addListSelectionListener(event -> {
            if (!event.getValueIsAdjusting() && tablaVC.getSelectedRow() != -1) {
    ...
    private void cargarDatosCamposDesdeTabla() {
        int fila = tablaVC.getSelectedRow();
        if (fila >= 0) {
    ...
    private void limpiarCampos() {
        ...
        tablaVC.clearSelection();
    }

    private void agregarRegistro() {
        AgregarRegistroFrameVc agregarFrame = new AgregarRegistroFrameVc();
    ...
    private void modificarRegistro() {
        ...
        String sql = "UPDATE VillaCattleya SET Capacidad = ?, TamanodeLote = ?, Ubicacion = ?, Precio = ?, Utilidades = ? WHERE CodigoVC = ?";
    ...
    private void eliminarRegistro() {
        ...
        int confirm = JOptionPane.showConfirmDialog(this, "¿Está seguro de eliminar el registro con Código VC " + codigo + "?", "Confirmar eliminación", JOptionPane.YES_NO_OPTION);

        if (confirm == JOptionPane.YES_OPTION) {
            String sql = "DELETE FROM VillaCattleya WHERE CodigoVC = ?";
    ...
    private void cargarDatosDesdeBD() {
        ...
        String consulta = "SELECT CodigoVC, Capacidad, TamanodeLote, Ubicacion, Precio, Utilidades FROM VillaCattleya";
    ...
    private void buscarRegistros() {
        ...
        modeloTabla.setRowCount(0);
        String consulta = "SELECT CodigoVC, Capacidad, TamanodeLote, Ubicacion, Precio, Utilidades FROM VillaCattleya WHERE LOWER(Ubicacion) LIKE ? OR CodigoVC = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VillaCattleya.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VillaCattleya().setVisible(true);
            }
        });
    }
