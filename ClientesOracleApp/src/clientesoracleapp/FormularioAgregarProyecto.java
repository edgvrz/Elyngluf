...
import java.awt.*;
import java.sql.*;
public class FormularioAgregarProyecto extends javax.swing.JFrame {
   ...
   private JTextField txtCodigo, txtNombreProyecto, txtCapacidad, txtTamanoLote, txtUbicacion, txtPrecio, txtUtilidades;
    ...
    public FormularioAgregarProyecto() {
        ...
        txtNombreProyecto = new JTextField(15);
        ...
        gbc.gridx = 0; gbc.gridy++; add(new JLabel("Nombre Proyecto:"), gbc);
        gbc.gridx = 1; add(txtNombreProyecto, gbc);
    ...
    private void guardarProyecto() {
        if (txtCodigo.getText().isEmpty() || txtNombreProyecto.getText().isEmpty() ||
            txtCapacidad.getText().isEmpty() || txtTamanoLote.getText().isEmpty() ||
            txtUbicacion.getText().isEmpty() || txtPrecio.getText().isEmpty() ||
            txtUtilidades.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Complete todos los campos", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }

        String sql = "INSERT INTO Proyectos (Codigo, NombreProyecto, Capacidad, TamanoDelLote, Ubicacion, Precio, Utilidades) VALUES (?, ?, ?, ?, ?, ?, ?)";

        try (Connection conn = DriverManager.getConnection(URL, USER, PASSWORD);
             PreparedStatement ps = conn.prepareStatement(sql)) {

            ps.setInt(1, Integer.parseInt(txtCodigo.getText()));
            ps.setString(2, txtNombreProyecto.getText());
            ps.setInt(3, Integer.parseInt(txtCapacidad.getText()));
            ps.setInt(4, Integer.parseInt(txtTamanoLote.getText()));
            ps.setString(5, txtUbicacion.getText());
            ps.setDouble(6, Double.parseDouble(txtPrecio.getText()));
            ps.setDouble(7, Double.parseDouble(txtUtilidades.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormularioAgregarProyecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
